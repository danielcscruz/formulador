...
Description: CMSMasters Content Composer created by <a href="https://cmsmasters.net/" title="CMSMasters">CMSMasters</a> team. Content Composer plugin create custom visual editor with shortcodes & settings integrated to WordPress default content editor for new <a href="https://themeforest.net/user/cmsmasters/portfolio" title="cmsmasters">cmsmasters</a> WordPress themes.
Version: 1.4.6
Author: cmsmasters
...
/*  Copyright 2014 CMSMasters (email : cmsmstrs@gmail.com). All Rights Reserved.
	...
	https://cmsmasters.net/files/license/cmsms-content-composer/license.txt 
...
class Cmsms_Content_Composer { 
	function __construct() { 
		define('CMSMS_CONTENT_COMPOSER_VERSION', '1.4.6');
		...
		require_once(CMSMS_CONTENT_COMPOSER_PATH . 'framework/cmsms-composer-templates-post-type.php');
		...
		require_once(CMSMS_CONTENT_COMPOSER_PATH . 'inc/project/projects-post-type.php');
		
		require_once(CMSMS_CONTENT_COMPOSER_PATH . 'inc/profile/profiles-post-type.php');
		
		require_once(CMSMS_CONTENT_COMPOSER_PATH . 'inc/like/likes-post-type.php');
	...
	function cmsms_composer_enqueue_scripts($hook) {
		...
		/* Start cmsms_portfolio Translations */	
			...
			'portfolio_field_col_count_descr_note_custom' =>	__('And 5 columns will be shown only if custom content width is set and when content area width is 1350px or more.', 'cmsms_content_composer'),
