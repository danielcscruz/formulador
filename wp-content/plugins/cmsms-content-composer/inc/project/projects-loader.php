...
if (isset($_POST['offset'])) {
	...
	if ($cmsms_query->have_posts()) : 
		while ($cmsms_query->have_posts()) : $cmsms_query->the_post();
			if ($layout == 'puzzle') {
				if (get_post_format() != '') {
					get_template_part('framework/post-type/portfolio/page/puzzle/' . get_post_format());
				} else {
					get_template_part('framework/post-type/portfolio/page/puzzle/standard');
				}
			} else {
				if (get_post_format() != '') {
					get_template_part('framework/post-type/portfolio/page/grid/' . get_post_format());
				} else {
					get_template_part('framework/post-type/portfolio/page/grid/standard');
				}
			}
		endwhile;
	endif;
