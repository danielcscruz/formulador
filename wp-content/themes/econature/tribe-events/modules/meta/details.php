...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<div class="cmsms_event_meta_info">
		...
		$cmsms_event_tags = tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'econature' ), tribe_get_event_label_singular() ), ', ', false );
		
		if ($cmsms_event_tags) {
			echo '<div class="cmsms_event_meta_info_item cmsms_event_tags">' . 
				'<dl>' . tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'econature' ), tribe_get_event_label_singular() ), ', ', false ) . '</dl>' . 
			'</div>';
		}
		?>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<div class="cmsms_event_meta_info_item">
				...
				<span class="cmsms_event_meta_info_item_descr tribe-events-event-url"><?php echo wp_kses( $website, 'post' ); ?></span>
			</div>
		<?php endif ?>
