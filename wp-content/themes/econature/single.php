...
if (have_posts()) : the_post();
	...
	if ($cmsms_layout == 'fullwidth') {
		if (get_post_format() != '') {
			get_template_part('framework/post-type/blog/post/fullwidth/' . get_post_format());
		} else {
			get_template_part('framework/post-type/blog/post/fullwidth/standard');
		}
	} else {
		if (get_post_format() != '') {
			get_template_part('framework/post-type/blog/post/sidebar/' . get_post_format());
		} else {
			get_template_part('framework/post-type/blog/post/sidebar/standard');   
		}
	}
