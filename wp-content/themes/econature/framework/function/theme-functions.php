	...
	if (!is_admin()) {
		...
		if (CMSMASTERS_EVENTS_CALENDAR) {
			if ( tribe_events_views_v2_is_enabled() ) {
				wp_enqueue_style('theme-cmsms-events-v2-style', get_template_directory_uri() . '/css/cmsms-events-v2-style.css', array(), '1.0.0', 'screen');
			} else {
				...
				if (is_rtl()) {
					wp_enqueue_style('theme-cmsms-events-rtl', get_template_directory_uri() . '/css/cmsms-events-rtl.css', array(), '1.0.0', 'screen');
				}
			}
		}
...
function cmsms_theme_page_layout_scheme() {
	...
	$cmsms_layout = apply_filters('cmsms_theme_page_layout_filter', $cmsms_layout);
	
	$cmsms_page_scheme = apply_filters('cmsms_theme_page_scheme_filter', $cmsms_page_scheme);
