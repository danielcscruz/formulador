...
if (CMSMASTERS_EVENTS_CALENDAR) {
	...
	if ( tribe_events_views_v2_is_enabled() ) {
		...
		$cmsms_event_title = '_h2';
		$cmsms_event_smaller_title = '_h3';
		$cmsms_event_meta = '_h6';
		$cmsms_single_title = '_h1';
		$cmsms_widget_title = '_h3';
...
/***************** Start Tribe Events Font Styles ******************/
	...
	.tribe-events-calendar-month__calendar-event-tooltip * {
		font-family:" . cmsms_get_google_font( $cmsms_option[ CMSMS_SHORTNAME . '_content_font_google_font' ] ) . $cmsms_option[ CMSMS_SHORTNAME . '_content_font_system_font' ] . " !important;
	}
	...
	.cmsmasters_tribe_events_views_v2 .tribe-events-single .tribe-events-single-event-title {
		font-family:" . cmsms_get_google_font( $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_google_font' ] ) . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_system_font' ] . ";
		font-size:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_font_size' ] . "px;
		line-height:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_line_height' ] . "px;
		font-weight:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_font_weight' ] . ";
		font-style:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_font_style' ] . ";
		text-transform:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_text_transform' ] . ";
		text-decoration:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_single_title . '_font_text_decoration' ] . ";
	}
	...
	.cmsmasters_tribe_events_views_v2 .tribe-events-single ul.tribe-related-events li .tribe-related-events-title {
		font-family:" . cmsms_get_google_font( $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_google_font' ] ) . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_system_font' ] . ";
		font-size:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_font_size' ] . "px;
		line-height:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_line_height' ] . "px;
		font-weight:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_font_weight' ] . ";
		font-style:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_font_style' ] . ";
		text-transform:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_text_transform' ] . ";
		text-decoration:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_text_decoration' ] . ";
	}

	.tribe-events-calendar-month__calendar-event-tooltip .tribe-events-calendar-month__calendar-event-tooltip-title {
		font-size:" . ( (int) $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_font_size' ] - 2 ) . "px;
		line-height:" . ( (int) $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_title . '_font_line_height' ] - 2 ) . "px;
	}
	...
	@media only screen and (max-width: 540px) {
		...
		.tribe-events-calendar-month__calendar-event-tooltip .tribe-events-calendar-month__calendar-event-tooltip-title,
		.cmsmasters_tribe_events_views_v2 .tribe-events-single ul.tribe-related-events li .tribe-related-events-title {
			font-family:" . cmsms_get_google_font( $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_google_font' ] ) . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_system_font' ] . ";
			font-size:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_font_size' ] . "px;
			line-height:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_line_height' ] . "px;
			font-weight:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_font_weight' ] . ";
			font-style:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_font_style' ] . ";
			text-transform:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_text_transform' ] . ";
			text-decoration:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_text_decoration' ] . ";
		}
	
		.tribe-events-calendar-month__calendar-event-tooltip .tribe-events-calendar-month__calendar-event-tooltip-title {
			font-size:" . ( (int) $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_font_size' ] - 2 ) . "px;
			line-height:" . ( (int) $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_smaller_title . '_font_line_height' ] - 2 ) . "px;
		}
	}
	...
	.cmsmasters_tribe_events_views_v2 .tribe-events-widget.tribe-common.tribe-events.tribe-events-view--widget-events-list .tribe-events-widget-events-list__header-title {
		font-family:" . cmsms_get_google_font( $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_google_font' ] ) . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_system_font' ] . ";
		font-size:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_font_size' ] . "px;
		line-height:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_line_height' ] . "px;
		font-weight:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_font_weight' ] . ";
		font-style:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_font_style' ] . ";
		text-transform:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_text_transform' ] . ";
		text-decoration:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_widget_title . '_font_text_decoration' ] . ";
	}
	...
	.cmsmasters_tribe_events_views_v2 .tribe-events-widget.tribe-common.tribe-events.tribe-events-view--widget-events-list .tribe-events-widget-events-list__event-organizer-title-wrapper a {
		font-family:" . cmsms_get_google_font( $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_google_font' ] ) . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_system_font' ] . ";
		font-size:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_font_size' ] . "px;
		line-height:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_line_height' ] . "px;
		font-weight:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_font_weight' ] . ";
		font-style:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_font_style' ] . ";
		text-transform:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_text_transform' ] . ";
		text-decoration:" . $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_text_decoration' ] . ";
	}
	...
	.cmsmasters_tribe_events_views_v2 .tribe-events-widget.tribe-common.tribe-events.tribe-events-view--widget-featured-venue .tribe-events-widget-featured-venue__event-datetime-wrapper,
	.cmsmasters_tribe_events_views_v2 .tribe-events-widget.tribe-common.tribe-events.tribe-events-view--widget-events-list .tribe-events-widget-events-list__event-datetime-wrapper {
		font-size:" . ( (int) $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_font_size' ] - 2 ) . "px;
		line-height:" . ( (int) $cmsms_option[ CMSMS_SHORTNAME . $cmsms_event_meta . '_font_line_height' ] - 2 ) . "px;
	}
