...
";
		...
		if (CMSMASTERS_EVENTS_CALENDAR) {
			...
			if ( tribe_events_views_v2_is_enabled() ) {
				$events_rule = ( ( 'default' !== $scheme ) ? "html .cmsmasters_tribe_events_views_v2 .cmsms_color_scheme_{$scheme} " : '' );
				$rule_skeleton = ( ( 'default' !== $scheme ) ? "html .cmsmasters_tribe_events_views_v2.cmsms_tribe_events_style_mode_skeleton .cmsms_color_scheme_{$scheme} " : '' );
				$hover_rule = ( ( 'default' !== $scheme ) ? "html #page.cmsmasters_tribe_events_views_v2 .cmsms_color_scheme_{$scheme} " : '' );

				$cmsms_event_meta = '_color';
...
/***************** Start {$title} Tribe Events Color Scheme Rules ******************/
	...
	{$events_rule} .tribe-events-widget.tribe-common.tribe-events.tribe-events-view--widget-events-list .tribe-events-widget-events-list__event-organizer-contact {
		" . cmsms_color_css( 'color', $cmsms_option[ CMSMS_SHORTNAME . '_' . $scheme . $cmsms_event_meta ] ) . "
	}
	...
	{$events_rule} .tribe-events .tribe-events-c-top-bar__nav-link:hover path {
		" . cmsms_color_css( 'color', $cmsms_option[ CMSMS_SHORTNAME . '_' . $scheme . '_hover' ] ) . "
		" . cmsms_color_css( 'fill', $cmsms_option[ CMSMS_SHORTNAME . '_' . $scheme . '_hover' ] ) . "
	}
	...
	{$events_rule} .tribe-events .tribe-events-c-top-bar__nav-link path {
		" . cmsms_color_css( 'color', $cmsms_option[ CMSMS_SHORTNAME . '_' . $scheme . '_border' ] ) . "
		" . cmsms_color_css( 'fill', $cmsms_option[ CMSMS_SHORTNAME . '_' . $scheme . '_border' ] ) . "
	}
