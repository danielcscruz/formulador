...
var objColor = {
	...
	menu_five_link_color: ".header-style-5 #main-nav > ul > li > a",
	menu_five_link_color_hover: ".header-style-5 #main-nav > ul > li > a:hover",
...
// Logo 5 Margin
wp.customize("logofive_margin", function(e) {
    e.bind(function(e) {
        var o = $(".customizer-logofive_margin");
        if (e) {
            var t = '<style class="customizer-logofive_margin">@media only screen and (min-width: 992px) { .header-style-5 #site-logo-inner { margin: ' + e + "; } }</style>";
            o.length ? o.replaceWith(t) : $("head").append(t)
        } else o.remove()
    })
});
...
var objWidth = {
	...
	site_desktop_container_width: ".site-layout-full-width .agrikole-container, .site-layout-boxed #page",
