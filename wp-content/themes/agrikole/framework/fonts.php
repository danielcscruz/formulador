...
function agrikole_standard_fonts() {
	return array(
...
function agrikole_google_fonts_array() {
...
function agrikole_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = agrikole_google_fonts_array();
	...
	// Subset
	$subset = agrikole_get_mod( 'google_font_subsets', 'latin' );
	...
	// Enqueue style
	wp_enqueue_style( 'agrikole-google-font-'. $handle, $url, false, false, 'all' );
}