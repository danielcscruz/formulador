...
if ( ! class_exists( 'Agrikole_Sanitize_Data' ) ) {
	class Agrikole_Sanitize_Data {
...
// Helper function runs the Agrikole_Sanitize_Data class
function agrikole_sanitize_data( $data = '', $type = '' ) {
	if ( $data && $type ) {
		$class = new Agrikole_Sanitize_Data();
